...
const sendMessage = async (message) => {
  ...
  async function makePostRequest(msg) {
    const url = 'www.example.comhttps://astifdla-5000.theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai/chatbot';  // Make a POST request to this url
    const requestBody = {
      prompt: msg
    };
